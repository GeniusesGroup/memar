...
## Drawbacks
- This document's numeric comparisons (255^16 vs. 2^48, CAM table ranges) depend on assumptions (uniform hop-port width, symmetric port numbering) that may not hold in every real topology; they are illustrative, not a guarantee for any specific deployment.
