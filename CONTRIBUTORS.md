...
- [eMail](mailto:omidhekayati@gmail.com)
- [Linkedin](https://www.linkedin.com/in/omidhekayati)
- Role: CTO in [Geniuses.Group](https://geniuses.group/). Lead architect of the Memar framework.
...
- Models:
  ...
  - [GPT-5.6-terra](https://platform.openai.com/api/docs/models/gpt-5.6-terra)
  - [GPT-5.6-sol](https://platform.openai.com/api/docs/models/gpt-5.6-sol)
  - [GPT-6-astra](https://platform.openai.com/api/docs/models/gpt-6-astra)
...
- Models:
  ...
  - [Gemini 3.8 flash](https://deepmind.google/models/gemini/flash/)
