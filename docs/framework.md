...
- Memar's concepts and protocols are language-independent. The repository currently hosts Khayyam toolchain work and module material as one realization of those contracts; a system's implementation language is a realization choice made where that system is developed.
