...
- Contributors:
  ...
  - [ox-alpha](../CONTRIBUTORS.md#ox-alpha) — rewrote: performed the revision.
...
- Contributors:
  ...
  - [ox-alpha](../CONTRIBUTORS.md#ox-alpha) — applied: implemented the rulings and drafted the pending additions.
...
- Contributors:
  ...
  - [ox-alpha](../CONTRIBUTORS.md#ox-alpha) — applied: transcribed the rulings and added two further preemptive notes (first-traffic-as-path-validation; header-integrity delegation to layer-1 CRCs).
...
- Contributors:
  ...
  - [ox-alpha](../CONTRIBUTORS.md#ox-alpha) — applied: performed the extraction and repointed the references.
