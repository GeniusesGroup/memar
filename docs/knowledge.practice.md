---
name: knowledge
description: procedures for working with knowledge in Memar — questioning, researching, and evaluating it
---

# Knowledge Practice

> **Purpose:** This practice operationalizes [knowledge.md](./knowledge.md): the followable procedures that working with knowledge actually consists of. The concept, the Data→Information→Knowledge→Document hierarchy, and the modeling principles live in [knowledge.md](./knowledge.md) — that document is assumed reading, and its rules are not restated here. Three procedures are reserved and seeded below; each grows as real use demonstrates what it needs. They were previously held as three separate placeholder files (`knowledge-question.practice.md`, `knowledge-research.practice.md`, `knowledge-evaluate.practice.md`), merged into this single companion per the one-practice-per-base-document rule.
...
Gathering evidence for a claim or a document, so that provenance survives the work session that produced it.

- Judge candidate sources by the selection criteria stated once in [Documentation → Citations](./documentation.md#citations): peer-reviewed or standards-body sources over vendor self-description; visible reasoning over polished assertion; testable-behavior claims over self-assessments of motive.
- Record each source as a structured citation in the paired changelog's `Cited` field — with its Relation and the reason it was used — not as a passing mention in the base document.
- Prefer sources you can actually access and verify over remembered or second-hand references; an unverified citation is a placeholder for error.

---

## Evaluating

Judging whether something qualifies as knowledge — for the system, not just for the person who wrote it.
