...
- Cited:
  ...
  - [Related Work Survey (AI-generated research)](../researchs/semantic_primitive_discovery-related_work-z.ai.md) — Reference: background survey of prior art (RDF, RDFa, JSON-LD, Topic Maps, XForms, etc.). Treat as exploratory research, not architectural authority — see [Documentation — Research → Relationship to the Other Facets](./documentation-research.md#relationship-to-the-other-facets) for the distinction between research findings and adopted understanding.
- Contributors:
